        ...
        <tbody id="fieldTable">
            <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="row-<?php echo e($f->id); ?>">
                    <td class="name"><?php echo e($f->name); ?></td>
                    <td class="price" data-raw="<?php echo e($f->price_per_hour); ?>">
                        <?php echo e(number_format($f->price_per_hour, 0, ',', '.')); ?></td>
                    <td>
                        <button class="btn btn-warning btnEdit" data-id="<?php echo e($f->id); ?>">Edit</button>
                        <button class="btn btn-danger btnDelete" data-id="<?php echo e($f->id); ?>">Hapus</button>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\futsal-booking\resources\views/fields/index.blade.php ENDPATH**/ ?>